...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    if (!isSpeechRecognitionAPIAvailable) {
      alert('Infelizmente seu navegador não suporta gravação de aúdio!')
      return
    }
            ...
            <form className='flex-1 flex flex-col'>
              ...
              {isRecording ? (
                <button type='button'
                  ...
                  className='flex items-center justify-center gap-2 w-full bg-slate-900 py-4 text-center text-sm
                  text-slate-300 outline-none font-bold hover:text-slate-100'>
                ...
                text-lime-950 outline-none font-bold hover:bg-lime-500'>
                  Salvar nota
                </button>
              )}
            </form>
